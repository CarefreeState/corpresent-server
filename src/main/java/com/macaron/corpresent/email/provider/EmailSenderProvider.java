package com.macaron.corpresent.email.provider;
...
import com.macaron.corpresent.email.config.EmailSenderConfig;
import com.macaron.corpresent.email.provider.strategy.ProvideStrategy;
